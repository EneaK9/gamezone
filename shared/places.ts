...
export const PLACES: PlaceDef[] = [
  ...
  { id: "blacksmith", name: "Tetsu's forge", description: "Blacksmith and sword shop on the north side of the main street", x: -86, z: -5 },
  { id: "apothecary", name: "Oume's apothecary", description: "Medicine and herbal remedy shop on the south side of the main street", x: -72, z: 5 },
  { id: "armorer", name: "Masa's armory", description: "Armor shop on the north side of the main street, east of the square", x: -12, z: -5 },
  { id: "general_store", name: "Kichibei's general store", description: "Traveling merchant's shop selling hats, masks, food and odds and ends, south side of the main street", x: 4, z: 5 },
  { id: "noodle_stall", name: "Genzo's noodle stall", description: "Ramen and food stall at the square", x: -28, z: 7 },
  { id: "dojo", name: "the dojo", description: "Sword training hall of Sensei Hideaki, north of the square", x: -40, z: -72 },
  { id: "inn", name: "the Sakura Inn", description: "Inn with rooms to rest for the night, south of the square", x: -40, z: 70 },
  { id: "tea_house", name: "the tea house", description: "Tea house with red umbrellas, where dice games are played; southeast of the square", x: 0, z: 53 },
  { id: "west_gate", name: "the west gate", description: "Main gate of the village with the guard post and watchtower", x: -156, z: 0 },
  { id: "north_gate", name: "the north gate", description: "Small gate at the north wall, toward the forest and the bandit camp", x: -40, z: -118 },
  { id: "south_gate", name: "the south gate", description: "Gate in the south wall that opens onto the farm fields", x: -40, z: 112 },
  ...
  { id: "pier", name: "the fishing pier", description: "Wooden pier on the west bank of the river where the fisherman works", x: 47, z: 72 },
